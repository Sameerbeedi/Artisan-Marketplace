...
export function RecommendationSearch({
  ...
  const updatePriceRange = (values: number[]) => {
    setFilters((prev: UserPreference) => ({
      ...prev,
      ...
      {showFilters && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Narrow down your search with specific preferences
            </CardDescription>
          </CardHeader>
      ...
      {recommendations && (
        <div className="space-y-4">
          ...
          {recommendations.suggestedFilters &&
            Object.keys(recommendations.suggestedFilters).length > 0 && (
              <Card>
                <CardHeader>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {recommendations.suggestedFilters.categories?.map(
                      (cat: string) => (
                        <Button
                          key={cat}
                          variant="outline"
                          size="sm"
                          onClick={() =>
                            handleQuickSearch(`Show me more ${cat} products`)
                          }
                        >
                          More {cat}
                        </Button>
